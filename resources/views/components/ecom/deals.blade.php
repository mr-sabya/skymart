                    ...
                    <div class="product-img-action-wrap">
                        <div class="product-img">
                            <a href='shop-product-right.html'>
                                <img src="{{ url('assets/frontend/imgs/banner/banner-5.png') }}" alt="" />
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="product-cart-wrap style-2">
                    <div class="product-img-action-wrap">
                        <div class="product-img">
                            <a href='shop-product-right.html'>
                                <img src="{{ url('assets/frontend/imgs/banner/banner-6.png') }}" alt="" />
                            </a>
                        </div>
                    </div>
                    <div class="product-content-wrap">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                <div class="product-cart-wrap style-2">
                    <div class="product-img-action-wrap">
                        <div class="product-img">
                            <a href='shop-product-right.html'>
                                <img src="{{ url('assets/frontend/imgs/banner/banner-7.png') }}" alt="" />
                            </a>
                        </div>
                    </div>
                    <div class="product-content-wrap">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                <div class="product-cart-wrap style-2">
                    <div class="product-img-action-wrap">
                        <div class="product-img">
                            <a href='shop-product-right.html'>
                                <img src="{{ url('assets/frontend/imgs/banner/banner-8.png') }}" alt="" />
                            </a>
                        </div>
                    </div>
                    <div class="product-content-wrap">
