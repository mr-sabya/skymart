<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="{{ Route::is('admin.dashboard') ? 'mm-active' : '' }}" href="{{ route('admin.dashboard')}}">
                    <div class="menu-icon">
            ...
            <li class="{{ Route::is('admin.tag.*') ? 'mm-active' : '' }}">
                <a href="{{ route('admin.tag.index')}}" class="{{ Route::is('admin.tag.*') ? 'mm-active' : '' }}">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="{{ Route::is('admin.slider.*') ? 'mm-active' : '' }}">
                <a href="{{ route('admin.slider.index')}}" class="{{ Route::is('admin.slider.*') ? 'mm-active' : '' }}">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path d="M17 4H6C4.79111 4 4 4.7 4 6V18C4 19.3 4.79111 20 6 20H18C19.2 20 20 19.3 20 18V7.20711C20 7.0745 19.9473 6.94732 19.8536 6.85355L17 4ZM17 11H7V4H17V11Z" fill="#90959F" />
            ...
            <li class="{{ Route::is('admin.banner.*') ? 'mm-active' : '' }}">
                <a href="{{ route('admin.banner.index')}}" class="{{ Route::is('admin.banner.*') ? 'mm-active' : '' }}">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path d="M17 4H6C4.79111 4 4 4.7 4 6V18C4 19.3 4.79111 20 6 20H18C19.2 20 20 19.3 20 18V7.20711C20 7.0745 19.9473 6.94732 19.8536 6.85355L17 4ZM17 11H7V4H17V11Z" fill="#90959F" />
            ...
            <li class="{{ Route::is('admin.service.*') ? 'mm-active' : '' }}">
                <a href="{{ route('admin.service.index')}}" class="{{ Route::is('admin.service.*') ? 'mm-active' : '' }}">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path d="M17 4H6C4.79111 4 4 4.7 4 6V18C4 19.3 4.79111 20 6 20H18C19.2 20 20 19.3 20 18V7.20711C20 7.0745 19.9473 6.94732 19.8536 6.85355L17 4ZM17 11H7V4H17V11Z" fill="#90959F" />
            ...
            <li class="{{ Route::is('admin.team.*') ? 'mm-active' : '' }}">
                <a href="{{ route('admin.team.index')}}" class="{{ Route::is('admin.team.*') ? 'mm-active' : '' }}">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path d="M17 4H6C4.79111 4 4 4.7 4 6V18C4 19.3 4.79111 20 6 20H18C19.2 20 20 19.3 20 18V7.20711C20 7.0745 19.9473 6.94732 19.8536 6.85355L17 4ZM17 11H7V4H17V11Z" fill="#90959F" />
