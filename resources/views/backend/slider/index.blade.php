                    ...
                    <table id="example3" class="display table image-table" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('admin.slider.edit', $slider->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa-solid fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="delete btn btn-danger shadow btn-xs sharp" data-url="{{ route('admin.slider.destroy', $slider->id) }}"><i class="fa-solid fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
